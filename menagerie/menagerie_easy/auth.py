...
from menagerie_easy import db, login_manager
from menagerie_easy.forms import LoginForm, SignupForm, UpdateProfileForm
from menagerie_easy.models import User
